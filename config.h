...
static const char *fonts[]          = { "Source Code Pro:size=11:antialias=true;autohint=true", "monospace:size=10" };
static const char dmenufont[]       = "Source Code Pro:size=11:antialias=true;autohint=true";
...
static const Key keys[] = {
	...
	// added
	{ MODKEY,                       XK_w,      spawn,       {.v = (const char*[]){ "alacritty", "--command", "qutebrowser"} } },
	{ MODKEY|ShiftMask,			    XK_w,	   spawn,		{.v = (const char*[]){ "brave", NULL } } },
	{ MODKEY,			            XK_d,	   spawn,       {.v = (const char*[]){ "dmenu_run", NULL } } },
	{ MODKEY,                       XK_period, spawn,       {.v = (const char*[]){ "emojis", NULL } } },
	{ MODKEY,                       XK_p,      spawn,       {.v = (const char*[]){ "alacritty", "--command", "ncspot"} } },
	{ MODKEY|ShiftMask,             XK_p,      spawn,       {.v = (const char*[]){ "spotify", NULL } } },
	{ MODKEY,       				XK_c,      spawn,     	{.v = (const char*[]){ "alacritty", "--command", "pulsemixer"} } },
	{ MODKEY,       				XK_z,      spawn,     	{.v = (const char*[]){ "alacritty", "--command", "lf"} } },
